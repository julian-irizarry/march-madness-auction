...
function AuctionPanelFrame() {
  const outerPath =
    "M124 446 L156 218 L240 154 H452 L492 108 L550 74 H730 L788 108 L828 154 H1040 L1124 218 L1156 446 L1108 476 H792 L764 506 H516 L488 476 H172 Z";
  const innerPath =
    "M150 430 L180 231 L251 177 H458 L514 116 L542 99 H738 L766 116 L822 177 H1029 L1100 231 L1130 430 L1094 455 H797 L771 480 H509 L483 455 H186 Z";
  ...
  return (
    ...
    >
      <defs>
        ...
        <filter
          id="bid-panel-electric-displace"
          x="-12%"
          y="-12%"
          width="124%"
          height="124%"
      ...
      <path
        d={outerPath}
        fill="url(#bid-panel-shell-fill)"
        filter="url(#bid-panel-glow)"
      />
      <path d={outerPath} fill="url(#bid-panel-shell-sheen)" opacity="0.22" />
      <path
        d={outerPath}
        fill="none"
        stroke="url(#bid-panel-border-energy)"
        strokeWidth="10.5"
      ...
      <path
        d={outerPath}
        fill="none"
        stroke="url(#bid-panel-electric-haze)"
        strokeWidth="6.3"
        strokeLinejoin="round"
        opacity="0.28"
      />
      <path
        d={outerPath}
        fill="none"
        stroke="url(#bid-panel-electric-core)"
        strokeWidth="3.8"
        strokeLinejoin="round"
        filter="url(#bid-panel-electric-displace)"
      />
      <path
        d={outerPath}
        fill="none"
      ...
      <path
        d={innerPath}
        fill="none"
        stroke="url(#bid-panel-inner-stroke)"
        strokeWidth="1.15"
        strokeLinejoin="round"
        opacity="0.42"
      />
      ...
      <path
        d={timerEdgePath}
        fill="none"
        stroke="url(#bid-panel-timer-stroke)"
        strokeWidth="3"
        strokeLinecap="round"
        opacity="0.84"
      />
      <path
        ...
        strokeOpacity="0.22"
        strokeLinecap="round"
        filter="url(#bid-panel-soft-blur)"
      />
      <path
        d="M1082 416 L1038 199"
        stroke="#ff4b28"
        strokeWidth="1.3"
        strokeOpacity="0.22"
        strokeLinecap="round"
      ...
      />
      <path
        d="M1156 446 L1126 222 L1103 215"
        fill="none"
        stroke="#ff6a47"
        strokeWidth="1"
        strokeOpacity="0.12"
      />
      <path
        d="M98 386 L72 510 H142 L162 448 Z"
        fill="url(#bid-panel-brace-fill)"
        opacity="0.94"
      />
      <path
        d="M1182 386 L1208 510 H1138 L1118 448 Z"
        fill="url(#bid-panel-brace-fill)"
        opacity="0.94"
      />
      <path
        d="M98 386 L72 510 H142 L162 448"
        fill="none"
        stroke="#ff5130"
        strokeWidth="1"
        strokeOpacity="0.1"
      ...
      />
      <path
        d="M1182 386 L1208 510 H1138 L1118 448"
        fill="none"
        stroke="#ff5130"
        strokeWidth="1"
        strokeOpacity="0.1"
      ...
      />
      <path
        d="M506 476 L530 500 H750 L774 476"
        fill="none"
        stroke="#ff6f4f"
        strokeWidth="1.1"
        strokeOpacity="0.14"
      ...
      <path
        d="M0 520 H1280"
        stroke="url(#bid-panel-shadow-fill)"
        strokeWidth="54"
      />
    </svg>
  );
...
function AuctionBiddingPanel(props: AuctionBiddingPanelProps) {
  ...
  const isSeedBundle =
    props.team.region === "bundle" &&
    (props.team.seed === 15 || props.team.seed === 16);
  const showLogo = !isSeedBundle && hasActiveTeam;
  const displaySeedLabel =
    hasActiveTeam && !isSeedBundle && props.team.seed > 0
      ? `#${props.team.seed}`
      : "";
  const displayTeamName = hasActiveTeam
    ? isSeedBundle
      ? `${props.team.seed}-seed bundle`
      : props.team.shortName
    : "Awaiting next team";
  const teamRegionLabel =
    props.team.region && props.team.region !== "bundle"
  ...
  const teamAccentBase = getTeamAccent(
    props.team.urlName,
    props.team.shortName,
  );
      ...
      <div className="bid-panel">
        ...
        <div className="bid-panel__content">
          <div className="bid-panel__timer-anchor">
            <div
              className={`bid-panel__timer ${props.countdown <= 3 ? "bid-panel__timer--urgent" : ""}`}
            >
              <span className="bid-panel__timer-value">
                {formatCountdown(props.countdown)}
              </span>
            </div>
          </div>
          ...
          <div className="bid-panel__safe-area">
            <div className="bid-panel__body">
              <div className="bid-panel__headline-stack">
                ...
                <div
                  className={`bid-panel__headline-row ${showLogo ? "" : "bid-panel__headline-row--compact"}`}
                >
                  {showLogo && (
                  ...
                  <h2 className="bid-panel__title">
                    <span className="bid-panel__title-text">
                      {displayTeamName}
                    </span>
                    {displaySeedLabel && (
                      <span className="bid-panel__seed">
                        {displaySeedLabel}
                      </span>
                    )}
                  </h2>
                ...
                <div className="bid-panel__current">
                  ...
                  <strong className="bid-panel__current-value">
                    {formatCurrency(props.currentHighestBid)}
                  </strong>
                  <span className="bid-panel__current-status">
                    {currentBidStatus}
                  </span>
                </div>
              </div>
              ...
              <div className="bid-panel__controls-wrap">
                <Bid
                  ...
                  team={
                    props.team.seed > 0
                      ? `${props.team.shortName} (${props.team.seed})`
                      : props.team.shortName
                  }

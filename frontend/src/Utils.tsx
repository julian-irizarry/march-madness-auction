...
const resolvedBackendHost =
  backendHost === "0.0.0.0" ? browserHostname : backendHost;
const pageProtocol =
...
export function normalizeTeamKey(
  team: Pick<TeamInfo, "shortName" | "urlName" | "region" | "seed">,
) {
...
export function GenerateRegionBracketData(regionTeams: TeamInfo[]): Match[] {
  ...
  [...regionTeams]
    ...
    .forEach((team) => {
      ...
      if (
        !existing ||
        scoreBracketTeamCandidate(team) > scoreBracketTeamCandidate(existing)
      ) {
...
export function IntegrateMatchResults(
